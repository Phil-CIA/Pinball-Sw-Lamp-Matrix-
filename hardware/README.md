...
This folder contains the KiCad project files for the pinball switch + lamp matrix board.

## Current state
- `Pinball Matrix board Rev 1.kicad_sch` is the working schematic source.
